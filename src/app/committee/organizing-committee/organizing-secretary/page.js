  ...
  return (
        <div className="overflow-x-hidden pb-10 bg-[#222831]">
            ...
            <div className='flex w-screen justify-evenly items-center my-5 flex-col sm:flex-row sm:h-auto h-screen'>
                <ConveyerCard img={'/images/thakurSirImg.jpg'} name={'Dr. NileshSingh V. Thakur'} des={'Professor'} dep={'Computer Science and Engineering'} />
                <ConveyerCard img={'/images/kavitaMamImg.jpg'} name={'Kavita Singh'} des={'Professor'} dep={'Computer Technology'} />
            </div>
        </div>
  )
}
