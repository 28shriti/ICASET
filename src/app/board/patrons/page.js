...
function page() {
    return (
        <div className='py-20 backdrop-blur-lg bg-[#31363f]'>
            <div className="mx-auto w-full rounded-lg px-10 py-4 self-center bg-opacity-60 h-[70vh] overflow-y-auto no-scrollbar">
                <h1 className="text-white text-center text-4xl mb-10 font-extrabold">Patrons</h1>
                <div className='flex flex-column flex-wrap justify-center gap-x-5 gap-y-5'>
