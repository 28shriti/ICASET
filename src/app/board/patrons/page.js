...
function page() {
    return (
        <div className='py-20'>
            <div className=" mx-auto w-9/12 grid grid-cols-3 rounded-lg py-3 self-center bg-[#31363F] bg-opacity-60 h-[70vh] overflow-y-auto no-scrollbar">
            <h1 className="text-white text-center text-4xl font-extrabold">Patrons</h1>
                {patrons.map((val, index) => {

                    return (<div key={index} className="text-white bg-[#222831] gap-5 py-3 transparent items-center grid grid-cols-3 rounded-full ">
                        <div >
