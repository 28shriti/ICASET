...
export default function KeynoteSpeakers() {
    return <div className="w-full flex flex-col items-center backdrop-blur-md">
        <h1 className="text-4xl m-10 font-extrabold text-white w-fit bg-[#222831] px-5 py-3 rounded-xl bg-opacity-70">Keynote Speakers</h1>
        <div className="grid grid-cols-4 gap-20 p-20 pt-5">
