        ...
        <MainContainer>
            <div className="overflow-x-hidden backdrop-blur-md backdrop-contrast-50 p-2 md:p-10 text-white">
                <div className=" bg-[#222831] p-10 bg-opacity-70 lg:mb-10 rounded-3xl">
                    ...
                    <br />
                    <div className="leading-4 md:leading-5 lg:leading-normal text-sm md:text-md lg:text-lg lg:px-20">
                        <strong className="text-xl">
                            First Author Registration Fees
                        </strong> <br />
                        <table className="border-black border-2 mt-2 w-full text-center text-justify">
                            <tbody>
                                <tr>
                    ...
                    <div className="leading-4 md:leading-5 lg:leading-normal text-sm md:text-md lg:text-lg lg:px-20">
                        <div><strong className="text-xl">Registration Fees - Co-Author or Attendee or Listener or Spouse intrested to participate in person</strong><br />
                            ...
                            <table className="border-2 border-black my-2 w-full text-justify">
                                <tbody>
                                    <tr>
                    ...
                    <br />
                    <div className="text-justify leading-4 md:leading-5 lg:leading-normal text-sm md:text-md lg:text-lg lg:px-20">
                        <div className="text-xl">Payment option : </div>

                        {/* <a href="/"className=" underline">Payment Link</a><br /> */}

                        <table className="border-2 border-black my-2 w-full">
                            <tbody>
                                <tr>
                                    <td className="border-2 p-2 text-center">Account Name</td>
                                    <td className="border-2 p-2 text-center">Yeshwantrao Chavan College of Engineering</td>
                                </tr>
                                <tr>
                                    <td className="border-2 p-2 text-center">Account Number</td>
                                    <td className="border-2 p-2 text-center">1472002100003909</td>
                                </tr>
                                <tr>
                                    <td className="border-2 p-2 text-center">IFSC Code</td>
                                    <td className="border-2 p-2 text-center">PUNB0147200</td>
                                </tr>
                                <tr>
                                    <td className="border-2 p-2 text-center">Name of the Bank</td>
                                    <td className="border-2 p-2 text-center">Punjab National bank, Khamla branch, Nagpur 440025</td>
                                </tr>
                                <tr>
                                    <td className="border-2 p-2 text-center">Type of account</td>
                                    <td className="border-2 p-2 text-center">Current account</td>
                                </tr>
                                <tr>
                                    <td className="border-2 p-2 text-center">MICR No</td>
                                    <td className="border-2 p-2 text-center">440024008</td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div className="text-justify leading-4 md:leading-5 lg:leading-normal text-sm md:text-md lg:text-lg lg:px-20">
                        <p><strong className="text-xl">Step 2 - Registration</strong><br />
                            ...
                            Send your completed registration form along with the scanned copy of the proof of payments to <b>actphase1@outlook.com</b>
                        </p>
                    </div>
                    <br />
                    <br />
                    ...
                    <div className="leading-4 md:leading-5 lg:leading-normal text-sm md:text-md lg:text-lg lg:px-20">
                        <div>
                            ...
                            <div className="mt-2 text-justify">The CAMERA-READY PAPER common TEMPLATE, available at <a href="/documents/grenze_template.docx" className=" font-bold underline">DOC</a>. </div>
