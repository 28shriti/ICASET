...
const Header = () => {
  return (
    <div className="bg-[#31363F] text-white w-full m-0 p-3 lg:py-[1rem] lg:px-[3rem] flex justify-between items-center">
      ...
      <Image src={'/images/icaset_logo.png'} width={250} height={130} alt="icaset_Logo" className=" hidden md:block mix-blend-screen" />
      ...
      <Image src={'/images/ycceLogoNew.png'} alt="ycce_Logo" className="hidden md:block" height={100} width={250}/>
    </div>
  );
};
